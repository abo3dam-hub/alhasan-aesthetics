...
- **أسئلة شائعة للمناطق المخدومة** (بانتظار الإضافة من اللوحة): 3 أسئلة ثنائية اللغة جاهزة — "هل تستقبلون مرضى من طرطوس / لبنان / العراق؟" — تُشير لعيادات دمشق واللاذقية ودبي مع الحجز عبر واتساب؛ تلتقطها بيانات FAQPage تلقائيًا فور إضافتها.
